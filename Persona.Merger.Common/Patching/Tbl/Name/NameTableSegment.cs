...
namespace Persona.Merger.Patching.Tbl.Name;
...
public struct NameTableSegment
{
    ...
    public int CalculateTotalLength()
    {
        ...
        int offsetSegmentLength = Mathematics.RoundUp((Names.Count * 2) + segmentSizeLength, TblSegmentFinder.TblSegmentAlignment);
        ...
        return offsetSegmentLength + Mathematics.RoundUp(stringSegmentLength, TblSegmentFinder.TblSegmentAlignment);
    }
    ...
    public void Serialize(ExtendedMemoryStream stream)
    {
        ...
        stream.AddPadding(TblSegmentFinder.TblSegmentAlignment);
